      ...
      <main>
          ...
          <div className="container workspace-grid">
            ...
            <div className="workspace-copy">
              <div className="section-head">
                ...
                <p>
                  Move from seller-level opportunity to price-level analysis. Review
        ...
        <section className="section" id="how">
          <div className="container workflow">
            <div className="section-head">
              ...
              <p>
                Connect Amazon data, let the pricing analytics system evaluate recent sales behavior,
                then review recommendations or start the AI co-pilot workflow.
              </p>
            </div>
            ...
            <div className="steps">
              ...
              <div className="step">
                ...
                <p>The system reviews the last 60 days, pricing activity, pricing evidence, revenue opportunity, and cost completeness.</p>
              </div>
              <div className="step">
                <div className="step-num">3</div>
                <h3>Review recommendations</h3>
                <p>Use Pricing Workspace to inspect recommended prices, expected impact, ads context, and price history.</p>
              </div>
              <div className="step">
                <div className="step-num">4</div>
                <h3>Start AI co-pilot</h3>
                <p>Use monitoring mode first, then move toward controlled pricing automation when you are ready.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="section" id="early-access">
          <div className="container">
            <div className="section-head">
              <h2>Early access during beta.</h2>
              <p>
                Holocene is currently available as an early access pricing analytics system
                for Amazon Private Label sellers. Start with a free pricing analysis and
                review product-level opportunities before enabling automation workflows.
              </p>
            </div>
            ...
            <div className="cards-3">
              <div className="feature">
                ...
                <p>Built for sellers who control their own product pricing and need product-level decision support.</p>
              </div>
              <div className="feature">
                <h3>Evidence-aware</h3>
                <p>Recommendations are supported by pricing evidence, activity level, and recent sales behavior.</p>
              </div>
              <div className="feature">
        ...
        <section className="section">
          <div className="container cta">
            <div>
              ...
              <p>
                Connect Amazon data, review your pricing dashboard, and open Pricing Workspace
